                  ...
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">Lather Bag</Link>
                        </h4>
                        <p>$325.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">Eye Castal</Link>
                        </h4>
                        <p>$25.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">High Heel Baby</Link>
                        </h4>
                        <p>$75.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">White Shoes</Link>
                        </h4>
                        <p>$325.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">Black Jacket</Link>
                        </h4>
                        <p>$99.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">Diamond Ring</Link>
                        </h4>
                        <p>$325.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">Makeup Box</Link>
                        </h4>
                        <p>$85.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">Sofa With Balish</Link>
                        </h4>
                        <p>$89.00</p>
                      </div>
                ...
                >
                  <div className="shop-page__single">
                    ...
                    <div className="shop-page__single-content">
                      <div className="text-box">
                        <h4>
                          <Link href="/shop-details">Baby Sunglass</Link>
                        </h4>
                        <p>$35.00</p>
                      </div>
