...
export default function Home() {
  return (
    <>
      <Layout headerStyle={3} footerStyle={1} breadcrumbTitle="Our Projects">
        <div>
          {/*Start Project Three */}
                  ...
                  <div className="project-three__single">
                    <div className="project-three__single-inner">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(assets/img/project/project-v3-img7.jpg)",
                        }}
                      ></div>
                      <div className="bg-overlay"></div>
                      ...
                      <div className="project-three__overlay-icon">
                        <ul>
                          <li>
                            <Link
                              className="img-popup"
                              href="assets/img/project/project-v3-img7.jpg"
                            >
                              <span className="icon-search-interface-symbol"></span>
                            </Link>
                          </li>
                  ...
                  <div className="project-three__single">
                    <div className="project-three__single-inner">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(assets/img/project/project-v3-img8.jpg)",
                        }}
                      ></div>
                      <div className="bg-overlay"></div>
                      ...
                      <div className="project-three__overlay-icon">
                        <ul>
                          <li>
                            <Link
                              className="img-popup"
                              href="assets/img/project/project-v3-img8.jpg"
                            >
                              <span className="icon-search-interface-symbol"></span>
                            </Link>
                          </li>
                  ...
                  <div className="project-three__single">
                    <div className="project-three__single-inner">
                      <div
                        ...
                        style={{
                          backgroundImage:
                            "url(assets/img/project/project-v3-img9.jpg)",
                        }}
                      ></div>
                      <div className="bg-overlay"></div>
                      ...
                      <div className="project-three__overlay-icon">
                        <ul>
                          <li>
                            <Link
                              className="img-popup"
                              href="assets/img/project/project-v3-img9.jpg"
                            >
                              <span className="icon-search-interface-symbol"></span>
                            </Link>
                          </li>
