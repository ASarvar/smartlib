                        ...
                        <div className="col-xl-7 wow animated fadeInLeft" data-wow-delay="0.1s">
                            <div className="about-one__content">
                                <div className="sec-title">
                                    ...
                                    <h2>Leading RFID Solutions <br/>
                                        for Modern Libraries</h2>
                                </div>

                                <div className="text-box">
                                    <p>SmartLibrary is the official partner of Bibliotheca in Uzbekistan, providing cutting-edge RFID technology solutions for libraries, archives, and educational institutions. We specialize in library automation systems that enhance efficiency and improve user experience.</p>
                                </div>
                                ...
                                <div className="about-one__content-bottom">
                                    ...
                                    <div className="text">
                                        <h4>Need RFID solutions for your library? Call Us: <Link href="tel:+998711234567">+998 71 123 45 67</Link></h4>
                                    </div>
                                </div>
                            </div>
                        </div>
